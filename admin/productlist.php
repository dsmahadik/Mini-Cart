...
///////picture delete/////////
$result=mysqli_query($con,"select item_image from product where item_id='$product_id'")
or die("query is incorrect...");

list($picture)=mysqli_fetch_array($result);
$path="./assets/products/$picture";
...
{}
/*this is delet query*/
mysqli_query($con,"delete from product where item_id='$product_id'")or die("query is incorrect...");
}
	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php
                        ...
                        $result=mysqli_query($con,"select item_id,item_image, item_name,item_price from product Limit $page1,12")or die ("query 1 incorrect.....");
...
//counting paging
                ...
                $paging=mysqli_query($con,"select item_id,item_image,item_name,item_price from product");
